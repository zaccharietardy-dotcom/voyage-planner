...
export function Features() {
  ...
  const features = useMemo(() => [
    ...
    },
    {
      ...
      description: t('features.collabDesc'),
      color: 'from-[#0f7a6a]/15 to-[#0f7a6a]/5 text-[#0f7a6a] dark:text-[#71d2bd]',
    },
    {
      icon: Utensils,
      title: t('features.restaurantsTitle'),
      description: t('features.restaurantsDesc'),
      color: 'from-[#d2833f]/15 to-[#d2833f]/5 text-[#d2833f] dark:text-[#f2be8b]',
    },
    {
      icon: Leaf,
      title: t('features.ecoTitle'),
