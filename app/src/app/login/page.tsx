      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <Link href="/" className="inline-block mb-4">
            <div className="mx-auto h-12 w-12 rounded-full bg-gradient-to-br from-[#1e3a5f] to-[#0f2744] flex items-center justify-center">
              <svg className="w-7 h-7" viewBox="0 0 32 32">
                <defs>
                  <linearGradient id="wing-login" x1="0%" y1="100%" x2="100%" y2="0%">
